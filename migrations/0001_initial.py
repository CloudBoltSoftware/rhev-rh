...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RhevOSBuildAttribute'
        db.create_table('rhev_rhevosbuildattribute', (
            ('osbuildattribute_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['externalcontent.OSBuildAttribute'], unique=True, primary_key=True)),
            ('template_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('rhev', ['RhevOSBuildAttribute'])

        # Adding model 'RhevResourceHandler'
        db.create_table('rhev_rhevresourcehandler', (
            ('resourcehandler_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['resourcehandlers.ResourceHandler'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('rhev', ['RhevResourceHandler'])

        # Adding M2M table for field os_build_attributes on 'RhevResourceHandler'
        db.create_table('rhev_rhevresourcehandler_os_build_attributes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('rhevresourcehandler', models.ForeignKey(orm['rhev.rhevresourcehandler'], null=False)),
            ('rhevosbuildattribute', models.ForeignKey(orm['rhev.rhevosbuildattribute'], null=False))
        ))
        db.create_unique('rhev_rhevresourcehandler_os_build_attributes', ['rhevresourcehandler_id', 'rhevosbuildattribute_id'])


    def backwards(self, orm):
        # Deleting model 'RhevOSBuildAttribute'
        db.delete_table('rhev_rhevosbuildattribute')

        # Deleting model 'RhevResourceHandler'
        db.delete_table('rhev_rhevresourcehandler')

        # Removing M2M table for field os_build_attributes on 'RhevResourceHandler'
        db.delete_table('rhev_rhevresourcehandler_os_build_attributes')
