...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'rhev_rhevresourcehandler', 'default_network_id')


    def backwards(self, orm):
        # Adding field 'RhevResourceHandler.default_network'
        db.add_column(u'rhev_rhevresourcehandler', 'default_network',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='resource_handlers_using_as_default', null=True, to=orm['rhev.RhevNetwork'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
    ...
    models = {
        u'accounts.group': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.Group']", 'null': 'True', 'blank': 'True'}),
