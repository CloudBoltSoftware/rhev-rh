...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RhevResourceHandler.default_network'
        db.alter_column(u'rhev_rhevresourcehandler', 'default_network_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rhev.RhevNetwork']))

    def backwards(self, orm):

        # Changing field 'RhevResourceHandler.default_network'
        db.alter_column(u'rhev_rhevresourcehandler', 'default_network_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rhev.RhevNetwork']))
    ...
    models = {
        u'accounts.group': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.Group']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.GroupType']"}),
        ...
        u'infrastructure.environment': {
            ...
            'custom_field_options': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['orders.CustomFieldValue']", 'null': 'True', 'blank': 'True'}),
            'custom_fields': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['infrastructure.CustomField']", 'null': 'True', 'blank': 'True'}),
            'data_center': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['infrastructure.DataCenter']", 'null': 'True', 'blank': 'True'}),
        ...
        u'rhev.rhevresourcehandler': {
            ...
            'default_network': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'resource_handlers_using_as_default'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rhev.RhevNetwork']"}),
