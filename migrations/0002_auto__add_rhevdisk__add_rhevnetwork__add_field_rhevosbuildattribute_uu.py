...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RhevDisk'
        db.create_table('rhev_rhevdisk', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('rhev', ['RhevDisk'])

        # Adding model 'RhevNetwork'
        db.create_table('rhev_rhevnetwork', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('rhev', ['RhevNetwork'])

        # Adding field 'RhevOSBuildAttribute.uuid'
        db.add_column('rhev_rhevosbuildattribute', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'RhevDisk'
        db.delete_table('rhev_rhevdisk')

        # Deleting model 'RhevNetwork'
        db.delete_table('rhev_rhevnetwork')

        # Deleting field 'RhevOSBuildAttribute.uuid'
        db.delete_column('rhev_rhevosbuildattribute', 'uuid')
