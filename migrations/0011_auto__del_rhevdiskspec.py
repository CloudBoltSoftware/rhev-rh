...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'RhevDiskSpec'
        db.delete_table(u'rhev_rhevdiskspec')


    def backwards(self, orm):
        # Adding model 'RhevDiskSpec'
        db.create_table(u'rhev_rhevdiskspec', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'rhev', ['RhevDiskSpec'])
    ...
    models = {
        ...
        u'accounts.userprofile': {
            ...
            'super_admin': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'quota.quota': {
            ...
            'available': ('django.db.models.fields.DecimalField', [], {'default': 'None', 'null': 'True', 'max_digits': '65', 'decimal_places': '10'}),
            'delegated': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '65', 'decimal_places': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'limit': ('django.db.models.fields.DecimalField', [], {'default': 'None', 'null': 'True', 'max_digits': '65', 'decimal_places': '10'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['quota.Quota']", 'null': 'True', 'blank': 'True'}),
            'total_used': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '65', 'decimal_places': '10'}),
            'used': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '65', 'decimal_places': '10'})
        },
        ...
        u'resourcehandlers.resourcehandler': {
            ...
            'serviceaccount': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'servicepasswd': ('secrets.fields.EncryptedPasswordField', [], {})
        },
        ...
        u'utilities.ldaputility': {
            ...
            'base_dn': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            ...
            'protocol': ('django.db.models.fields.CharField', [], {'default': "'ldap'", 'max_length': '10'}),
            'serviceaccount': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'servicepasswd': ('secrets.fields.EncryptedPasswordField', [], {}),
            'version': ('django.db.models.fields.CharField', [], {'default': "'3'", 'max_length': '3'})
        }
    }
