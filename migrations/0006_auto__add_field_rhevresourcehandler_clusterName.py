...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RhevResourceHandler.clusterName'
        db.add_column('rhev_rhevresourcehandler', 'clusterName',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RhevResourceHandler.clusterName'
        db.delete_column('rhev_rhevresourcehandler', 'clusterName')
